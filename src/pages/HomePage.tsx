...
const formatValue = (value: number, title: string = "") => {
    const isCurrency = title.toLowerCase().includes("marketcap") || title.toLowerCase().includes("volume");
    ...
    return (
        <Layout.Content className="p-4">
            ...
            <div className={"flex justify-between items-center mt-10 "}>
                ...
                <Typography.Link><Link to="/cryptocurrencies">Show more</Link></Typography.Link>
            </div>
